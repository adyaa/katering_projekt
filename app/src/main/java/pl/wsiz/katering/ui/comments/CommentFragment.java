...
import pl.wsiz.katering.Adapter.MyCommentAdapter;
import pl.wsiz.katering.Callback.ICommentCallbackListener;
...
public class CommentFragment extends BottomSheetDialogFragment implements ICommentCallbackListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        commentViewModel.getMutableLiveDataFoodList().observe(getActivity(), commentModels -> {
    ...
    //wczytywanie komentarzy użytkowników z bazy danych
