...
import pl.wsiz.katering.EventBus.CategoryClick;
...
public class MyCategoriesAdapter extends RecyclerView.Adapter<MyCategoriesAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
       ...
       //zaczyna się event:
        //wysyłanie notyfikacji do HomeActivity żeby pokazał się Toast
    ...
    //rozmieszczenie poszczególnych kategorii na ekranie:
    @Override
